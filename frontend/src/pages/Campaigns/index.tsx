                  ...
                  <div className="flex flex-1 overflow-hidden">
                    <div className="relative flex-1">
                      ...
                      >
                        ...
                        {isFullScreen && (
                          <Panel position="top-left" style={{ marginLeft: '340px' }} className="flex items-center gap-3 rounded-xl border border-slate-200/80 bg-white/90 p-2.5 shadow-lg backdrop-blur-md dark:border-slate-800/80 dark:bg-slate-950/90 pointer-events-auto">
