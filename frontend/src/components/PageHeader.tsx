...
export default function PageHeader({ eyebrow, title, description, actions, meta, screenLabel }: PageHeaderProps) {
  return (
    <header
      ...
      className="relative flex flex-col gap-4 border-b border-slate-200/80 pb-6 lg:flex-row lg:items-end lg:justify-between dark:border-slate-800"
    >
      <div className="min-w-0">
        ...
        <h1 className="mt-2 text-2xl font-semibold tracking-[-0.025em] text-slate-950 sm:text-[28px] dark:text-white">
          {title}
        </h1>
        {description && (
