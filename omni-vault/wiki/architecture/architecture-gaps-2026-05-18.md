...
## Honest priorities (my opinion at time of writing)
...
Tier 1, Tier 2, and Tier 3 (gaps 9, 10, 11) shipped in one batch via migration 013. Tier 4 partially: sticky_note landed (Gap 13); sub-graph and linked-templates still open.

See [[agent-runtime-2026-05-18]] for the Option C agent decision and [[node-audit-2026-05-18]] for the per-node truth table.
